...
class Fruit:
    ...
    def __init__(
        ...
        self.tile_position = [
            random.randrange(self.tile_min_x, self.tile_max_x),
            random.randrange(self.tile_min_y, self.tile_max_y),
        ]
        self.position_x = (
            self.tile_position[0] * self.tile_size
            + (self.tile_size - self.width) / 2
            + self.field_dimension[0][0]
        )
        self.position_y = (
            self.tile_position[1] * self.tile_size
            + (self.tile_size - self.width) / 2
            + self.field_dimension[1][0]
        )
